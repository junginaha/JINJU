...
const COMMENTS: Record<string, EditorialComment[]> = {
  "jinju-seed-20260731-public-child-guidance": [
    ...
    comment("daily-0731-child-humor-1", "쉿 담당", "한마디 하기 전 부모 반응, 직원 호출, 인터넷 후기까지 머릿속으로 검토하다 보면 아이는 이미 세 바퀴째입니다.", "2026-07-31T05:02:00+09:00"),
    comment("daily-0731-child-humor-2", "소음 사서", "도서관 책은 빌려가도 되지만 큰소리는 대출이 안 됩니다. 그 자리에서 조용히 반납 부탁드려요.", "2026-07-31T05:04:00+09:00"),
  ],
};
