...
export const SITE_DEFINITION = "진주(JINJU)는 개인정보 없이 할 말을 하는 익명 커뮤니티입니다.";
export const SITE_DISCLAIMER = "본 서비스는 경상남도 진주시 및 지방자치단체의 공식 서비스와 무관한 독립 서비스입니다.";
export const SITE_TITLE = `${SITE_NAME} — ${SITE_TAGLINE} | 익명 의견 커뮤니티`;
export const SITE_DESCRIPTION = SITE_DEFINITION;
