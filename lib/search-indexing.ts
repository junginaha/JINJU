...
export const SITE_TAGLINE = "개인정보 없이, 할 말은 하세요";
export const SITE_DEFINITION = "진주.kr은 전국 누구나 쓰는 독립 익명 의견 커뮤니티입니다.";
export const SITE_DISCLAIMER = "경상남도 진주시 및 지방자치단체의 공식 서비스와 무관합니다.";
export const SITE_TITLE = `${SITE_NAME} | 전국 누구나 쓰는 독립 익명 의견 커뮤니티`;
export const SITE_DESCRIPTION = `${SITE_DEFINITION} ${SITE_TAGLINE}.`;
