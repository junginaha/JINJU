import { createAdminCredential, hasValidMutationOrigin, isAdminRequest, timingSafeEqual } from "../../../../lib/admin-auth";
...
export async function POST(request: Request) {
  const limit = await rateLimit(request, "admin-setup", 5, 30 * 60_000);
