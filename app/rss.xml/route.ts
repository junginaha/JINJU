...
export async function GET() {
  ...
  const body = `<?xml version="1.0" encoding="UTF-8"?><rss version="2.0"><channel><title>진주.kr — 익명 의견 커뮤니티</title><link>https://xn--o55b9n.kr/</link><description>개인정보 없이 솔직한 의견을 나누는 익명 커뮤니티</description><language>ko-KR</language>${items}</channel></rss>`;
